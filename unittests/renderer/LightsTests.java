 ...
 * Includes single and multiple light source scenarios.
 *
...
class LightsTests {
     ...
     * Complies with Section 8 requirements (distinct colors, positions, and directions).
     */
    @Test
    @SuppressWarnings("java:S109")
    void testSphereMultiLight() {
        ...
        // 1. Directional Light - Red color, diagonal downwards direction
        _scene1.lights.add(new DirectionalLight(new Color(400, 0, 0), new Vector(1, -1, -1)));

        // 2. Point Light - Green color, positioned upper-left front
        _scene1.lights.add(new PointLight(new Color(0, 400, 0), new Point(-60, 60, 50))
                .setKl(0.001).setKq(0.0002));

        // 3. Spot Light - Blue color, positioned lower-right front, completely different beam direction
        _scene1.lights.add(new SpotLight(new Color(0, 0, 600), new Point(60, -60, 50), new Vector(-1, 1, -2))
                .setKl(0.001).setKq(0.0001));
    ...
    void testTrianglesMultiLight() {
        ...
        // 1. Directional Light - Pale green color, angled straight forward
        _scene2.lights.add(new DirectionalLight(new Color(200, 400, 200), new Vector(0, 1, -1)));

        // 2. Point Light - Deep blue color, positioned high and far back
        _scene2.lights.add(new PointLight(new Color(100, 100, 500), new Point(30, 50, -120))
                .setKl(0.0005).setKq(0.0002));

        // 3. Spot Light - Orange/Yellow color, positioned low, sharp oblique direction
        _scene2.lights.add(new SpotLight(new Color(600, 300, 100), new Point(-40, -50, -90), new Vector(1, 1, -1))
    ...
    /* --- Bonus tests for Narrow Beam (Commented out as per instructions) ---
    @Test
    @SuppressWarnings("java:S109")
