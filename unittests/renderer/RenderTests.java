...
class RenderTests {
    ...
    void testBasicRenderTwoColors() {
        Scene scene = new Scene("Two colors")                   //
                ...
                .setAmbientLight(new AmbientLight(new Color(122, 162, 247))); //
        ...
        baseCameraBuilder() //
                ...
                .build() //
                .renderImage() //
                .printGrid(100, new Color(187, 154, 247))
    ...
    Camera renderSceneXML(Camera.Builder builder, String xmlName) {
        // Create the scene completely from the external XML file using our dedicated parser
        Scene parsedScene = scene.SceneXmlParser.parse("Using XML", "xml/" + xmlName + ".xml");

        return builder //
                .setImageWriter(new ImageWriter(RESOLUTION, RESOLUTION)) //
                .setRayTracer(parsedScene, RayTracerType.SIMPLE) //
                .build() //
                .renderImage(); //
    }
